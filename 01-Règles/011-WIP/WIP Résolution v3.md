...
| Outils        | Dé  | Difficulté      | Seuil | Nv de competences |
| ------------- | --- | --------------- | ----- | ----------------- |
| Pas approprié | D4  | Confiant        | 2     | Maître            |
| Normal        | D6  | Incertain       | 4     |                   |
...
- **Maximum sur un dé** — **Ouverture** selon le type d'arme, le PJ peut choisir un effet, mais -1 usure ou -1d6 END si rate le test d’attribut associé.
    ...
    - _Toute arme_ :
        ...
        - (ESP) Feinte : pas de dégâts, mais bonus narratif _(à préciser)_.
- **Double, triple** : comme les tests d’action 
...
| Résultat sur le dé                | Tier               | Effet sur test instantané        |
| --------------------------------- | ------------------ | -------------------------------- |
| 16–20 sous                        | **T4 — Total**     | -1 Tenssion                      |
| 11–15 sous                        | **T3 — Critique**  | -1 Tenssion                      |
| 6–10 sous                         | **T2 — Marqué**    | -1 Tenssion                      |
| 0–5 sous l'attribut               | **T1 — Normal**    | Résultat escompté                |
| Égal à l'attribut, ou ≤ blessures | **T0 — Impasse**   | Payer 1d6 END pour T1, sinon T-1 |
| 16–20 au-dessus                   | **T-1 — Normal**   | Rien de se passe                 |
| 11–15 au-dessus<br>               | **T-2 — Marqué**   | +1 Tenssion                      |
| 6–10 au-dessus                    | **T-3 — Critique** | +1 Tenssion                      |
| 1–5 au-dessus                     | **T-4 — Total**    | +1 Tenssion                      |
