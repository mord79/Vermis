...
type: référence
statut: banquée
source: "https://elmc.at/against-maps/"
tags: [exploration, voyage, donjon, sandbox]
date: 2026-04-28
---

# [RÉF] Against Maps — Among Cats and Books

## Idée centrale

Une carte ne sert que si elle alimente la décision. Quatre modes à distinguer : (1) **carte régionale** — player-facing, suffisamment de routes/landmarks/rumeurs pour rendre la planification possible ; le blanc invite la découverte mais ne doit pas masquer le choix lui-même. (2) **carte du monde** — outil de contexte, pas d'exploration. (3) **carte de donjon** — ce sont les *connexions* qui comptent, pas le détail ; favorise les *partial dungeon maps* (à la Rise Up Comus) qui suppriment l'ambiguïté ennuyeuse sans tuer le mystère. (4) **battlemap** — souvent sur-détermine la fiction ; mieux vaut un croquis qui laisse de l'espace aux questions des joueurs. Principe-cadre : un hexcrawl = carte (les options) + procédure (leur coût et leur risque) ; les deux moitiés sont indissociables.
...
Pas une mécanique mais un cadre conceptuel — à mobiliser au moment de rédiger les sections sandbox / mégadonjon, pas avant.
