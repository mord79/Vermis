...
type: référence
statut: banquée
source: "https://goblinpunch.blogspot.com/2026/02/be-of-good-cheer.html"
tags: [repos, ressources, progression, social]
date: 2026-04-27
---

# [RÉF] Be of Good Cheer — Spirit Pool collectif

**Auteur** : Arnold K. (Goblin Punch)
**Catégories** : Repos / Guérison / Ressources de groupe / Barde

## Idée centrale

Le groupe partage une ressource collective appelée **Spirit** (confiance, bonne humeur). Elle se gagne de manière diégétique : repos en lieu sûr, nourriture de qualité, divertissement, amis PNJ, propreté. En jeu, elle s'utilise pour absorber des dégâts (1d4 par point dépensé). Elle fonctionne comme un deuxième pool de PV collectif, visible de tous, et élimine le besoin du clerc comme classe de base dédiée au soin.
...
- Quand vient le temps de formaliser les **procédures de repos et de camp**.
- Quand la question du **rôle mécanique du barde** est posée explicitement.
- Quand les **caractéristiques de groupe** (moral, cohésion, réputation) sont en développement.
- Si un playtest révèle que la létalité est trop punitive sans buffer collectif accessible.
- Si le downtime et la base ont besoin d'un ancrage mécanique au monde (récompense de l'exploration sociale).
