...
type: référence
statut: banquée
source: "https://orto-solis.blogspot.com/2026/04/subtley-is-dead-or-how-to-make-sure.html"
tags: [procédures-mj, donjon, exploration]
date: 2026-04-28
---

# [RÉF] Subtley is Dead — Orto Solis

## Idée centrale

La subtilité ne fonctionne pas en TTRPG : le MJ possède toute l'info, le médium oral gère mal le détail noyé dans une description, et chercher des subtilités déclenche le « 10ft pole creep » qui tue le rythme. Solution : ne pas obfusquer. Intégrer indices, pièges et menaces directement dans la description (« des étoiles dorées inversées forment un motif balayé ; certaines sont légèrement enfoncées » plutôt que la version neutre). Premier piège d'un donjon : toujours déjà déclenché — pose le ton. Foreshadower les monstres via spoor (cadavres, traces, sons, odeurs), donner des tells avant que la capacité spéciale frappe (fumée aux narines du dragon, chant du shaman, inspiration de la harpie). Multiplier les sens, pas que la vue.
