...
type: référence
statut: en-analyse
source: "https://rancourt.substack.com/p/common-osr-system-questions"
tags: [procédures-mj, town, voyage, donjon, combat]
date: 2026-04-28
---

# [RÉF] Common OSR System Questions — Rancourt

## Idée centrale

Checklist de questions concrètes qu'un système OSR doit pouvoir répondre — ou explicitement ne pas adresser. Inspirée des « twenty quick questions » de Jeff Rients, mais centrée sur les arbitrages mécaniques récurrents à la table : Town (vente/achat/craft, copie de sorts, embauche, downtime), Travel (encombrement, voyage, navigation), Adventure (saut, perception, sneaking, climbing, négociation, distance d'écoute, charm spells, lore checks, vitesse de mouvement, harvest), Combat (mouvement en round, race conditions, manœuvres, environnement, mort/dying, invisibilité, cover, tirs en mêlée).

Thèse implicite : transformer les *unknown-unknowns* en *known-unknowns*. Un bon système précise sa réponse OU dit explicitement « rulings, pas rules » sur chaque cas.
